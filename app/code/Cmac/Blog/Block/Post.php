...
class Indez_Blog_Block_Post extends Mage_Core_Block_Template {
    ...
    public function getPost() {
        if (!$this->hasData('post')) {
            ...
            $post->setCreatedTime($this->formatTime($post->getCreatedTime(), Mage::getStoreConfig('blogconfig/blog/dateformat'), true));
            $post->setUpdateTime($this->formatTime($post->getUpdateTime(), Mage::getStoreConfig('blogconfig/blog/dateformat'), true));
    ...
    public function getBookmarkHtml($post) {
        if (Mage::getStoreConfig('blogconfig/blog/bookmarkspost')) {
    ...
    public function getLoginRequired() {
        return Mage::getStoreConfig('blogconfig/comments/login');
    }
