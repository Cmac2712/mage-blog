...
class Indez_Blog_Block_Rss extends Mage_Rss_Block_Abstract {
    ...
    protected function _toHtml() {
        ...
        if (Mage::getStoreConfig('blogconfig/rss/image') != "") {
            $data['image'] = $this->getSkinUrl(Mage::getStoreConfig('blogconfig/rss/image'));
        }
        ...
        $collection->setPageSize((int) Mage::getStoreConfig('blogconfig/rss/posts'));
